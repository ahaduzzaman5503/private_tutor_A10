...
const ExtraSection = () => {
    return (
        <div>
            <div className='grid gap-5 my-10 justify-center items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-3  p-3'>
            ...
            <div className=' text-center text-3xl font-bold text-blue-500 py-5 grid gap-5 my-10 justify-center items-center grid-cols-1 md:grid-cols-2 lg:grid-cols-3  p-3'>
